...
def get_prompt(command, his_trajs=None, speed_content=None):
    ...
    instruct_promt = "Based on the provided particulars, please plan waypoints (0.5s intervals) for the next 2 seconds.\n"
...
def extract_decision_and_summary(result):
    ...
    if match:
        ...
        # 如果匹配失败，返回原始字符串或空值
        # If matching fails, return the original string or empty values
...
if __name__ == '__main__':
    ...
    base_folder = '/mnt/nas-data-1/zhanglingjun.zlj1/data/bench2drive-full'
    train_json = '/home/zhanglingjun.zlj/code/Bench2Drive/train_bev-large1230.jsonl'
    sub_train_json = 'train_bev_v4.jsonl'
